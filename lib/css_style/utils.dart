...
class StyleGenUtils {
  ...
  static Style addFontWeight(Style textStyle, String value) {
  ...
  static Style addFontColor(Style textStyle, String value) {
    return textStyle.copyWith(color: _convertColor(value));
  }

  /// Creates a [TextStyle] to handle CSS background
  static Style addBgColor(Style textStyle, String value) {
    return textStyle.copyWith(backgroundColor: _convertColor(value));
  }

  static Style addFontStyle(Style textStyle, String value) {
    if (value == "italic") {
  ...
  static Style addFontFamily(Style textStyle, String value) {
    return textStyle.copyWith(fontFamily: value);
  }

  /// Creates a [TextStyle] to handle CSS font-size
  static Style addFontSize(Style textStyle, String value) {
    double number = 14.0;
    try {
      ...
      return textStyle.copyWith(fontSize: FontSize(number));
    } catch (e) {
      print(e);
      return textStyle.copyWith(fontSize: FontSize(number));
    }
  ...
  static Style addTextDecoration(Style textStyle, String value) {
    if (value.indexOf("underline") != -1) {
      textStyle = textStyle.copyWith(textDecoration: TextDecoration.underline);
    }
    if (value.indexOf("overline") != -1) {
      textStyle = textStyle.copyWith(textDecoration: TextDecoration.overline);
    }
    if (value.indexOf("none") != -1) {
      return textStyle.copyWith(textDecoration: TextDecoration.none);
    }
    if (value.indexOf("line-through") != -1) {
      textStyle = textStyle.copyWith(textDecoration: TextDecoration.lineThrough);
    }
    if (value.indexOf("dotted") != -1) {
      textStyle =
          textStyle.copyWith(textDecorationStyle: TextDecorationStyle.dotted);
    } else if (value.indexOf("dashed") != -1) {
      textStyle =
          textStyle.copyWith(textDecorationStyle: TextDecorationStyle.dashed);
    } else if (value.indexOf("wavy") != -1) {
      textStyle = textStyle.copyWith(textDecorationStyle: TextDecorationStyle.wavy);
    }
    return textStyle;
  }

  /// Creates a [TextStyle] to handle CSS line-height
  static Style addLineHeight(Style textStyle, String value) {
    try {
